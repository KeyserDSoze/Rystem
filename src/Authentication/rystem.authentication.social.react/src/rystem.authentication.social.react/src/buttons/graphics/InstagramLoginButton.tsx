...
const configuration = {
    activeBackground: "linear-gradient(to right, rgb(214, 146, 60) 0%, rgb(160, 11, 143) 50%, rgb(56, 10, 115) 100%)",
    background: 'linear-gradient(to right, rgb(236, 146, 35) 0%, rgb(177, 42, 160) 50%, rgb(105, 14, 224) 100%)',
    iconColor: "#fff",
    color: "#fff",
    text: "Log in with Instagram",
    icon: (configuration) => (<svg xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", height: "auto" }} viewBox="0 0 169.063 169.063">
        <g fill={configuration.iconColor}>
