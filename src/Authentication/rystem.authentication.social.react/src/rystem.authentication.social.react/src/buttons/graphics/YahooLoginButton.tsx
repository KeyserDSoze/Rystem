...
const configuration = {
    activeBackground: "#ac3ade",
    background: '#720E9E',
    iconColor: "#fff",
    color: "#000",
    text: "Log in with Yahoo",
    icon: (configuration) => (<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        viewBox="0 0 291.319 291.319" xmlSpace="preserve"
        style={{ width: "100%", height: "auto" }} fill={configuration.iconColor}>
        <g>
            <path fill="transparent" d="M145.659,0c80.45,0,145.66,65.219,145.66,145.66c0,80.45-65.21,145.659-145.66,145.659
     S0,226.109,0,145.66C0,65.219,65.21,0,145.659,0z"/>
            <path fill="#FFFFFF" d="M212.353,114.98l0.155-0.027l4.825-5.371l-0.237-0.018l0.51-0.801h-67.595l2.604,9.249h18.444
