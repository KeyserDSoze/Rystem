...
namespace RepositoryFramework.Migration
{
         ...
         where TKey : notnull
    {
        ...
        public static readonly string OptionsKey = $"Rystem.Repository.Migration.{typeof(T).Name}.{typeof(TKey).Name}";
        public MigrationManager(
            IOptionsFactory<MigrationOptions<T, TKey>> optionsFactory,
        ...
        {
            _options = optionsFactory.Create(OptionsKey);
