...
namespace Microsoft.Extensions.DependencyInjection
{
    public static partial class RepositoryBuilderExtensions
    {
        ...
        /// <returns></returns>
        public static IRepositoryBuilder<T, TKey> WithTableStorage<T, TKey, TConnectionService, TKeyReader>(
            ...
            where TKeyReader : class, ITableStorageKeyReader<T, TKey>
        {
            ...
            builder.Services
               .AddOrOverrideFactory<ITableStorageKeyReader<T, TKey>, TKeyReader>(name, serviceLifetime);
            return builder;
        }
        /// <summary>
        ...
        /// <param name="serviceLifetime"></param>
        /// <returns></returns>
        public static ICommandBuilder<T, TKey> WithTableStorage<T, TKey, TConnectionService, TKeyReader>(
        ...
        /// <param name="serviceLifetime"></param>
        /// <returns></returns>
        public static IQueryBuilder<T, TKey> WithTableStorage<T, TKey, TConnectionService, TKeyReader>(
