    ...
    public static partial class ServiceCollectionExtesions
    {
        public static IServiceCollection AddFactory<TService, TImplementation>(this IServiceCollection services,
           ...
           where TImplementation : class, TService
            => services.AddEngineFactory<TService, TImplementation>(name, false, lifetime, implementationInstance, null, () => services.SendInError<TService, TImplementation>(name ?? string.Empty), null);
