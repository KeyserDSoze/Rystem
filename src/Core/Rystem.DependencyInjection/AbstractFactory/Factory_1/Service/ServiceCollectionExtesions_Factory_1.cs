    ...
    public static partial class ServiceCollectionExtensions
    {
        public static IServiceCollection AddFactory<TService>(this IServiceCollection services,
           ...
           where TService : class
            => services.AddEngineFactory<TService, TService>(name, true, lifetime, null, null, () => services.SendInError<TService, TService>(name), true, true);
        public static IServiceCollection AddFactory<TService, TOptions>(this IServiceCollection services,
            ...
            => services.AddFactory<TService, TService, TOptions>(createOptions, name, true, lifetime, null, null, () => services.SendInError<TService, TService>(name), true, true);
        public static IServiceCollection AddFactory<TService, TOptions, TBuiltOptions>(this IServiceCollection services,
            ...
            => services.AddFactory<TService, TService, TOptions, TBuiltOptions>(createOptions, name, true, lifetime, null, null, () => services.SendInError<TService, TService>(name), true, true);
        public static Task<IServiceCollection> AddFactoryAsync<TService, TOptions, TBuiltOptions>(this IServiceCollection services,
            ...
            where TBuiltOptions : class, IFactoryOptions
            => services.AddFactoryAsync<TService, TService, TOptions, TBuiltOptions>(createOptions, name, true, lifetime, null, null, () => services.SendInError<TService, TService>(name), true, true);
    }
}
