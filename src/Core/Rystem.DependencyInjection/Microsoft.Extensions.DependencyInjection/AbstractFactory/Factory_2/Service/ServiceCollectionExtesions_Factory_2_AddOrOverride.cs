namespace Microsoft.Extensions.DependencyInjection
{
    public static partial class ServiceCollectionExtesions
    {
        ...
        {
            var check = true;
            services.AddEngineFactory<TService, TImplementation>(name, true, lifetime, null, null, () => InformThatItsAlreadyInstalled(ref check), null);
            return check;
        }
        ...
        {
            var check = true;
            services.AddFactory<TService, TImplementation, TOptions>(createOptions, name, true, lifetime, null, null, () => InformThatItsAlreadyInstalled(ref check));
            return check;
        }
        ...
        {
            var check = true;
            services.AddFactory<TService, TImplementation, TOptions, TBuiltOptions>(createOptions, name, true, lifetime, null, null, () => InformThatItsAlreadyInstalled(ref check));
            return check;
        }
            ...
            where TBuiltOptions : class
        {
            var check = true;
            await services
                .AddFactoryAsync<TService, TImplementation, TOptions, TBuiltOptions>(createOptions, name, true, lifetime, null, null, () => InformThatItsAlreadyInstalled(ref check));
            return check;
        }
    }
}
